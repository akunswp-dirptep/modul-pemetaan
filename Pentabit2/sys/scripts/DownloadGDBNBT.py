...
gdbname = "Pekerjaan " + nama_pekerjaan + "_Menu " + nama_menu + "_Tahapan " + nama_tahapan + "_" + jenis_lokasi + "_" + lokasi + "_Tahun " + str(tahun) + "_Revisi Ke " + str(revisike) + "_znt_fgdb.gdb"  # Adjust this name as needed
