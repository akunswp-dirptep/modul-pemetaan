...
for row in arcpy.SearchCursor(sampel): 
    rowsa = arcpy.UpdateCursor (sampel_path, "ID_Bidang = " + str(row.ID_Bidang))
    for rowa in rowsa:
        rowa.setValue("Tgl_Penawaran_Transaksi", row.getValue ("Tgl_Penawaran_Transaksi"))
        rowa.setValue("Harga_Penyesuaian", row.getValue ("Harga_Penyesuaian"))
        rowa.setValue("Jenis_Data", row.getValue ("Jenis_Data"))
        rowa.setValue("Luas_Tanah_m2", row.getValue ("Luas_Tanah_m2"))
        rowa.setValue("Zoning", row.getValue ("Zoning"))
        rowa.setValue("Luas_Bangunan", row.getValue ("Luas_Bangunan"))
        rowa.setValue("Tahun_Pembuatan", row.getValue ("Tahun_Pembuatan"))
        rowa.setValue("Tahun_Renovasi", row.getValue ("Tahun_Renovasi"))
        rowa.setValue("Keadaan_Fisik", row.getValue ("Keadaan_Fisik"))
        rowa.setValue("Biaya_Bangunan_m2", row.getValue ("Biaya_Bangunan_m2"))
        rowa.setValue("Panjang", row.getValue ("Panjang"))
        rowa.setValue("RCN", row.getValue ("RCN"))
        rowa.setValue("Umur_Efektif", row.getValue ("Umur_Efektif"))
        rowa.setValue("Nilai_Bangunan", row.getValue ("Nilai_Bangunan"))
        rowa.setValue("Nilai_Bangunan_Rp", row.getValue ("Nilai_Bangunan_Rp"))
        rowa.setValue("Harga_Tanah", row.getValue ("Harga_Tanah"))
        rowa.setValue("nilluas", row.getValue ("nilluas"))
        rowa.setValue("nilai", row.getValue ("nilai"))
