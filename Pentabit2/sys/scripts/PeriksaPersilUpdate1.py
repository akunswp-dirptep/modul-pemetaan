...
peta_baru_path = os.path.join(dataset_path, "Persil")
...
if int(arcpy.GetCount_management(peta_indikator)[0]) > 0:
    arcpy.DeleteRows_management(peta_indikator)
...
arcpy.SetParameterAsText(1, "Peta_Lama")
arcpy.SetParameterAsText(2, "Peta_Baru")
arcpy.SetParameterAsText(3, peta_indikator)
