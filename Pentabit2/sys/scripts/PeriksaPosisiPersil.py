...
oid_fieldname = arcpy.Describe(jaringan_jalan_path).OIDFieldName
if 'IdJalan' not in field_names:
    arcpy.AddField_management(jaringan_jalan_path, 'IdJalan', "LONG")
arcpy.CalculateField_management(jaringan_jalan_path, "IdJalan", "!" + oid_fieldname + "!", "PYTHON")
...
arcpy.MakeFeatureLayer_management(persil_path, persil_fokus)
