...
arcpy.MakeFeatureLayer_management(persil_path, persil_fokus, "obj_konsol = 'Konsolidasi'")
arcpy.CopyFeatures_management(persil_fokus, persil_fokus_path)

arcpy.MakeFeatureLayer_management(persil_path, persil_baru_tetap, "obj_konsol = 'Non Konsolidasi'")
...
join_1 = "JoinPersilJalanKonsol_1"
...
exp = "get(!SUM_LebarSisi!, !lb_dpn!, !obj_konsol!)"
code_block = """
def get(a, b, c):
 if c == 'Konsolidasi':
  return a
...
exp = "get(!Persil_Konsolidasi.obj_konsol!, !PersilKonsolTetap.letak!, !Persil_Konsolidasi.letak!)"
code_block = """
def get(a, b, c):
    if a == 'Non Konsolidasi':
        return b
    else:
        return c"""
arcpy.CalculateField_management(persil, "letak", exp, "PYTHON", code_block)

exp = "get(!Persil_Konsolidasi.obj_konsol!, !PersilKonsolTetap.s_letak!, !Persil_Konsolidasi.s_letak!)"
code_block = """
def get(a, b, c):
    if a == 'Non Konsolidasi':
        return b
