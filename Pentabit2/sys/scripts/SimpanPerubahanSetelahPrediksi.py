...
shp_persil_prediksi = "Persil_Prediksi_Rev" + str(revisi_ke) + " " + kab_kota + " " + nama_kab_kota + " Tahun " + str(tahun) + ".shp"
...
output_persil_prediksi = os.path.join(out, shp_persil_prediksi)

if arcpy.Exists(output_sampel_model):
    arcpy.Delete_management(output_sampel_model)
if arcpy.Exists(output_persil_model):
    arcpy.Delete_management(output_persil_model)
if arcpy.Exists(output_sampel_prediksi):
    arcpy.Delete_management(output_sampel_prediksi)
if arcpy.Exists(output_persil_prediksi):
    arcpy.Delete_management(output_persil_prediksi)
...
arcpy.CopyFeatures_management(persil_prediksi_path, output_persil_prediksi)
