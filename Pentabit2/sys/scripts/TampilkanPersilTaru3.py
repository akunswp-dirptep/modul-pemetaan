...
#existing
in_fc1 = arcpy.GetParameter(0)
#taru
in_fc2 = arcpy.GetParameter(2)
dataset_path = ""
...
arcpy.FeatureClassToFeatureClass_conversion(in_fc1, dataset_path, persil)
arcpy.FeatureClassToFeatureClass_conversion(in_fc2, dataset_path, persil_taru)
...
if 'obj_taru' not in field_names:
    arcpy.AddField_management(persil_path, 'obj_taru', "TEXT")
arcpy.CalculateField_management(persil_path, 'obj_taru', "'non taru'", "PYTHON")
...
if arcpy.Exists(persil_taru):
    arcpy.Delete_management(persil_taru)
if arcpy.Exists("Persil_Existing"):
    arcpy.Delete_management("Persil_Existing")
...
arcpy.SetParameterAsText(3, persil_taru)

arcpy.MakeFeatureLayer_management(persil_path, "Persil_Existing")
# arcpy.ApplySymbologyFromLayer_management("Persil_Existing", sim_path)
arcpy.SetParameterAsText(1, "Persil_Existing")
