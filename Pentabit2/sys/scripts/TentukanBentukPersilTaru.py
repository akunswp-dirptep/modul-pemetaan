...
simbologi_Taru_path = os.path.join(appdata, "SimbologiPersilTaru.lyr")
...
persil_line_path = os.path.join(dataset_path, "PersilLineTaru")
persil_split_path = os.path.join(dataset_path, "PersilSplitTaru")

persil_dissolve_bentuk = "PersilDissolveTaruBentuk"
...
arcpy.AddMessage("== Hitung Bentuk Bidang Taru ==")
...
arcpy.MakeFeatureLayer_management(persil_update_path, persil_buat_bentuk, "obj_taru='taru'")
...
persil_bentuk = "Persil_Taru_Bentuk"
...
arcpy.ApplySymbologyFromLayer_management(persil_update, simbologi_Taru_path)
