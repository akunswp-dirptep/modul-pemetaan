...
JaringanJalanUpdate = "Jaringan_Jalan_Update_Topo"
...
if arcpy.Exists(JaringanJalanTopoTaru):
    arcpy.Delete_management(JaringanJalanTopoTaru)
if arcpy.Exists(JaringanJalanTopoKonsol):
    arcpy.Delete_management(JaringanJalanTopoKonsol)
