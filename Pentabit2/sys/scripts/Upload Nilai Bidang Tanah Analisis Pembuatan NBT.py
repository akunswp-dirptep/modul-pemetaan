...
zip_filename = f"Laporan Hasil Penilaian Tanah_Pembuatan NBT_{formatted_date}_{formatted_time}.zip"
...
def upload_zip_to_api(zip_path, username, project_id, tahun):
    ...
    payload = {
        ...
        "tahun": tahun,
        "step": "Analisis dan Pengolahan Data",
        "param": "Peta Nilai Bidang Tanah Analisis Pembuatan NBT"
    }
