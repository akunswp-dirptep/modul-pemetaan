...
for row in arcpy.SearchCursor(sampel): 
    ...
    for rowa in rowsa:
        ...
        rowa.setValue("Harga_Penawaran_Transaksi", row.getValue ("Harga_Penawaran_Transaksi"))
        rowa.setValue("Penyesuaian_Status_Kepemilikan", row.getValue ("Penyesuaian_Status_Kepemilikan"))
