...
if username and password and project_id and kategori and (in_feature or dokum):
    url = "http://10.20.57.231/api/index.php/aksi_login"
        ...
        if token:
            ...
            if check_tahun(tahun) == True:
                    ...
                    if zipname:
                        ...
                        url_upload = "http://10.20.57.231/api/index.php/upload_layer/test"
                        nam = y["namenya"]
                        kod = y["kodenya"]
                        ...
                        if 'kuki_cs_rf' in client.cookies:
                            csrftoken = client.cookies['kuki_cs_rf']
                        else:
                            csrftoken = client.cookies['kuki_cs_rf']
...
##                                          files={"filess": (fix_upload + '.zip', fileobj)},
