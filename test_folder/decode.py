...
VERSION_NUMBER = '5.8.4'
VERSION_NAME = 'Jayawijaya'
VERSION_ID = 'ular-medan-aceh-69d5d5c2-jzc'
...
config = get_all_config(r"E:\Akmal\Jobdesk\Uji Coba Plugin Penilaian Tanah\Pembuatan ZNT\Menguji Perubahan Konfig Import Workspace\penilaian_tanah_config.bin")
print(config)